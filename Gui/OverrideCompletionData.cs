...
namespace FSharpBinding
{
	class OverrideCompletionData : CodeCompletionData, IActionCompletionData
	{
		ILanguageItem item;
		TextEditor editor;
		FSharpAmbience ambience;
		string typedModifiers;
		int insertOffset;
		string indent;
		ITypeNameResolver resolver;
		
		public OverrideCompletionData (TextEditor editor, ILanguageItem item, int insertOffset, string typedModifiers, FSharpAmbience amb, ITypeNameResolver resolver)
		{
